...
--------------------------
Template generation, Azure blob download + parse, and bulk applicability updates.
"""
...
def _parse_uploaded_file_from_bytes(data: bytes, file_name: str) -> list[dict]:
    """Parse file body from Azure download. CSV streams via StringIO; Excel uses in-memory workbook."""

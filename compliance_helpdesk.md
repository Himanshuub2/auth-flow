...
- **Confirmation dialogue** on submit: "Do you want to submit ?"
- **Success popup**: " submitted successfully".
...
4. On **Submit Declaration**:
  ...
  - If valid → opens **confirmation dialogue**: "Do you want to submit ?"
...
All tables prefixed with `compliance`_. Using PostgreSQL with JSONB support.
...
| gift_details           | JSONB, nullable. Structure: `{ "status": "TO_BE_GIVEN"                                                                                   |
...
| sub_type            | Enum: COBCE_COI, R5_18                                                                           |
| schema_json         | JSONB, not null. Array of field definitions: `[{ "name": string, "label": string, "type": "text" |
